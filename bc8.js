...
// Mining Well
Block.defineBlock (174,'Mining Well',[['furnace',3],['stonecutter',2],['furnace',2],['furnace',2],['furnace',2],['furnace',2]],61,false,0)
Block.setShape (174,0,0,0,1,1,1)
Block.setDestroyTime (174,0.25)

// Auto Crafting Table
Block.defineBlock (175,'Automatic Crafting Table',[['planks',0],['stonecutter',2],['crafting_table',1],['crafting_table',1],['crafting_table',1],['crafting_table',1]],58,false,0)
Block.setShape (175,0,0,0,1,1,1)
Block.setDestroyTime (175,0.25)

// Builder
Block.defineBlock (176,'Builder',[['stonecutter',3],['stonecutter',3],['stonecutter',0],['stonecutter',0],['stonecutter',0],['stonecutter',0]],61,false,0)
...
// Wood Pipe
Block.defineBlock (178,'Wood Pipe',[['planks',0]],58,true,11)
Block.setDestroyTime (178,0.25)

// Cobblestone Pipe
Block.defineBlock (179,'Cobblestone Pipe',[['cobblestone',0]],61,true,11)
Block.setDestroyTime (179,0.25)

// Mining Well Pipe
Block.defineBlock (180,'Mining Well Pipe',[['wool',14]],58,false,11)
